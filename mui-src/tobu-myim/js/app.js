window.app = {
	 ...
	 * 后端服务发布的url地址
	 */
//	serverUrl: 'http://192.168.43.47:8080',
//	serverUrl: 'http://192.168.0.104:8080',
	serverUrl: 'http://139.196.102.109:8088',
...
//	nettyServerUrl: 'ws://192.168.0.104:8088/ws',
	...
	/**
	 * 封装消息提示框，默认mui的不支持居中和自定义icon，所以使用h5+的Toast
	 * @param {Object} msg
	 * @param {Object} type
	 */
	 ...
	 */
	userLogout: function() {
		mui.confirm("确定要退出登录吗?","提示",["确定","取消"],function(e){
			if (e.index == 0) {
	...
	/**
	 * 头像图片加载失败或者用户没有头像的处理,显示默认图片
	 */
	faceImgNotFind: function () {
		var imgEvent = event.srcElement;
		imgEvent.src = "image/head1.png";
	},
